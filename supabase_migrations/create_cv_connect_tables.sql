-- ========================================
-- CV Connect - Tables de base
-- ========================================

-- Table pour stocker les permissions CV Connect
CREATE TABLE IF NOT EXISTS cv_connect_permissions (
...
CREATE TABLE IF NOT EXISTS cv_connect_submissions (
  id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
  nom TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_cv_connect_permissions_user_id ON cv_connect_permissions(user_id);
CREATE INDEX IF NOT EXISTS idx_cv_connect_permissions_role ON cv_connect_permissions(role);
CREATE INDEX IF NOT EXISTS idx_cv_connect_submissions_email ON cv_connect_submissions(email);
CREATE INDEX IF NOT EXISTS idx_cv_connect_submissions_pole_id ON cv_connect_submissions(pole_id);
CREATE INDEX IF NOT EXISTS idx_cv_connect_submissions_filiere_id ON cv_connect_submissions(filiere_id);
CREATE INDEX IF NOT EXISTS idx_cv_connect_submissions_statut ON cv_connect_submissions(statut);
CREATE INDEX IF NOT EXISTS idx_cv_connect_submissions_submitted_at ON cv_connect_submissions(submitted_at);
