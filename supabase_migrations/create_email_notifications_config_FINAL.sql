-- Créer la table de configuration des notifications email (Version FINALE)
...
-- Insérer la configuration par défaut (ignorer si elle existe déjà)
...
-- Activer RLS (ignorer si déjà activé)
...
-- Créer la politique pour les admins
