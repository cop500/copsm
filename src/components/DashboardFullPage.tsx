    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative">
        ...
        <div className="relative z-10">
          ...
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Bienvenue dans votre espace COP ! 👋</h1>
            <p className="text-gray-600">Voici un aperçu des indicateurs clés et actions rapides</p>
          </div>
          ...
          <div className="relative mt-4">
            <div className="bg-white/20 backdrop-blur-md rounded-2xl p-4 shadow-xl border-2 border-black/30">
              <NotesModule />
            </div>
          </div>
        </div>
