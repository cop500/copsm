  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center w-full min-h-screen">
        <div className="bg-transparent backdrop-blur-sm border-2 border-white rounded-xl shadow-2xl p-6 sm:p-8 md:p-10 text-center max-w-2xl mx-auto">
          ...
          <a
            ...
            className="inline-block px-8 sm:px-10 py-4 bg-green-600 hover:bg-green-700 text-white rounded-lg font-bold text-base sm:text-lg transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 min-h-[48px] flex items-center justify-center"
          >
