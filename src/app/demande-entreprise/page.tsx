                ...
                <div className="md:col-span-2 mb-4">
                  ...
                  <div className="flex gap-4 mt-2">
                    <label className="flex items-center gap-2">
                      <input type="radio" name="evenement_type" value="jobday" checked={form.evenement_type === 'jobday'} onChange={e => setForm(prev => ({ ...prev, evenement_type: e.target.value }))} />
                      Oui, je souhaite organiser un Job Day
                    </label>
                    <label className="flex items-center gap-2">
                      <input type="radio" name="evenement_type" value="cv" checked={form.evenement_type === 'cv'} onChange={e => setForm(prev => ({ ...prev, evenement_type: e.target.value }))} />
                      Non, je souhaite seulement recevoir des CV ciblés
                    </label>
                  </div>
                </div>
