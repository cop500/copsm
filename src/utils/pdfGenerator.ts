...
const generateConclusion = (doc: jsPDF, data: PDFData) => {
  try {
    ...
    const conclusions = [
      ...
      '',
      `${data.enterpriseMetrics?.partners || 0} entreprises partenaires référencées (onglet Partenariats),`,
      'témoignant de l\'engagement du secteur privé dans l\'insertion professionnelle.',
      '',
      'Recommandations :',
